...
# para que el editor de mc sea micro
# alias mc='EDITOR=micro mc'
# para definir el editor que usara mc mejor modificar:
...
# para editor micro queda
# SELECTED_EDITOR="/usr/bin/micro"


# Start Screen Saver app xscreensaver-demo
# Pat aauto start Screensaver demon
# En startupapplications add:
# Name: XScreenSaver
...
CCYAN='\[\e[36m\]'
ENDCOLOR='\[\e[m\]'
#export PS1="\u@wsl: \[\e[32m\]\w\[\e[m\]\n$ "
#export PS1="${CCYAN}\u@\h: ${ENDCOLOR}${CVERDE}\w ${ENDCOLOR}${CCAFE}${THEIP}${ENDCOLOR}\n$ "

# con color
# export PS1="${CCYAN}\u@\h: ${ENDCOLOR}${CVERDE}\w \n$ "
...
bash_prompt() {
	...
	*)
	...
	############################################################################
	PS1="$TITLEBAR\n${PROMT_USER}${SEPARATOR_1}${PROMT_HOST}${SEPARATOR_2}${PROMT_PWD}${SEPARATOR_3}\n> ${PROMT_INPUT}"
